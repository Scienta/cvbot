...
import scienta.cvpartner_api.models
from scienta.cvpartner_api import rest
from scienta.cvpartner_api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(scienta.cvpartner_api.models, klass)
