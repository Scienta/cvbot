...
class Certification(BaseModel):
    ...
    year_expire: Optional[StrictStr] = None
    month_expire: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["order", "starred", "disabled", "version", "external_unique_id", "owner_updated_at", "created_at", "updated_at", "name", "long_description", "organizer", "year", "month", "year_expire", "month_expire"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "year": obj.get("year"),
            "month": obj.get("month"),
            "year_expire": obj.get("year_expire"),
            "month_expire": obj.get("month_expire")
        })
        return _obj
