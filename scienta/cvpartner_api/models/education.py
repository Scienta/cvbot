...
class Education(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["order", "starred", "disabled", "version", "external_unique_id", "owner_updated_at", "created_at", "updated_at", "degree", "description", "year_from", "month_from", "year_to", "month_to", "school"]
