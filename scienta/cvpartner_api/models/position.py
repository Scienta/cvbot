...
class Position(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["order", "starred", "disabled", "version", "external_unique_id", "owner_updated_at", "created_at", "updated_at", "name", "description", "year_from", "year_to"]
