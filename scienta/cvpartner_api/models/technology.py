...
class Technology(BaseModel):
    ...
    uncategorized: Optional[StrictBool] = None
    category: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["order", "starred", "disabled", "version", "external_unique_id", "owner_updated_at", "created_at", "updated_at", "uncategorized", "category"]
